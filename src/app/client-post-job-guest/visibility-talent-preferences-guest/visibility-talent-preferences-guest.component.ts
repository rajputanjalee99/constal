...
@Component({
  selector: 'app-visibility-talent-preferences-guest',
  templateUrl: './visibility-talent-preferences-guest.component.html',
  styleUrls: ['./visibility-talent-preferences-guest.component.scss']
})
export class VisibilityTalentPreferencesGuestComponent implements OnInit {
