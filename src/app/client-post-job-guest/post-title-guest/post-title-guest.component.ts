...
@Component({
  selector: 'app-post-title-guest',
  templateUrl: './post-title-guest.component.html',
  styleUrls: ['./post-title-guest.component.scss']
})
export class PostTitleGuestComponent implements OnInit {
