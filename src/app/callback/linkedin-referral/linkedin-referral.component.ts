...
@Component({
  selector: 'app-linkedin-referral',
  templateUrl: './linkedin-referral.component.html',
  styleUrls: ['./linkedin-referral.component.scss']
})
export class LinkedinReferralComponent implements OnInit {
