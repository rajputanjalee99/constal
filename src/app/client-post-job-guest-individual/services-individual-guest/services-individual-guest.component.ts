...
declare let $ : any
@Component({
  selector: 'app-services-individual-guest',
  templateUrl: './services-individual-guest.component.html',
  styleUrls: ['./services-individual-guest.component.scss']
})
export class ServicesIndividualGuestComponent implements OnInit {
...
this.selected_services.push(id)
  ...
  getClientSpecialityServices(){
    ...
    console.log("sp",obj)
    this.service.getClientSpecialityServicesGuest(obj).subscribe(async res => {
    console.log(res)
  ...
  console.log(this.speciality,this.service_name,this.category)
    if(this.speciality && this.service_name && this.category){
      ...
      this.service.addSpeServicesGuest(obj).subscribe(async res => {
         const item = {
            _id : res._id,
            name : res.name,
            status : res.status,
...
digital_service:JSON.parse(localStorage.getItem('digitalServices')),
  ...
  deleteSpecialityService(type,service_id){
    if(service_id){
      ...
      this.service.deleteSpecialityServiceGuest(obj).subscribe(async res => {
        switch(type){
          case 'traditional':
